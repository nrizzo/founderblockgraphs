...
#define CMDLINE_PARSER_VERSION "0.1b"
#endif
...
struct gengetopt_args_info
{
  ...
  char * output_arg;	/**< @brief Index output path.  */
  char * output_orig;	/**< @brief Index output path original value given at command line.  */
  const char *output_help; /**< @brief Index output path help description.  */
  long gap_limit_arg;	/**< @brief Gap limit (default='1').  */
  char * gap_limit_orig;	/**< @brief Gap limit original value given at command line.  */
  const char *gap_limit_help; /**< @brief Gap limit help description.  */
  int elastic_flag;	/**< @brief Semi-repeat-free segmentation and elastic founder graph as a result (default=off).  */
  const char *elastic_help; /**< @brief Semi-repeat-free segmentation and elastic founder graph as a result help description.  */
