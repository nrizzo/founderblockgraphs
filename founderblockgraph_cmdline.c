...
const char *gengetopt_args_info_purpose = "Constructs a (semi-)repeat-free (elastic) founder block graph";

const char *gengetopt_args_info_usage = "Usage: founderblockgraph --input=MSA.fasta --output=MSA.index [--elastic]\n[--gap-limit=GAPLIMIT] [--graphviz-output=…]";

const char *gengetopt_args_info_versiontext = "";

const char *gengetopt_args_info_description = "Input is MSA given in fasta format. Rows with runs of gaps ‘-’ or N’s ≥\nGAPLIMIT will be filtered out";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -e, --elastic                 Semi-repeat-free segmentation and elastic\n                                  founder graph as a result  (default=off)",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->graphviz_output_help = gengetopt_args_info_help[6] ;
  args_info->memory_chart_output_help = gengetopt_args_info_help[7] ;
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'e':	/* Semi-repeat-free segmentation and elastic founder graph as a result.  */
